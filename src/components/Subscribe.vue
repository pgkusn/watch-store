            ...
            <form class="max-w-[350px] mx-auto md:ml-0" @submit.prevent="subscribe">
                ...
                <div class="flex mt-5">
                    <input
                        ...
                        class="flex-grow w-0 h-[60px] pl-[14.5px] rounded-l border-2 border-dark-golden placeholder-dark-gray outline-none"
                        required
                    >
                    <input type="submit" value="Subscribe" class="w-[129px] h-[60px] text-white rounded-r bg-dark-golden cursor-pointer">
                </div>
            </form>
        </div>
    </div>
